# Лабораторная работа №1 "Написание первого кода на языке C#"
...
Для упрощения выбора нужного типа проекта воспользуйтесь фильтрами в верхней части окна создания нового проекта
![](../img/create_project.png)
На первом этапе выберите вариант Console App (.NET Framework)
Разницу между ним и вариантом .NET рассмотрена в [файле](./CS_10+_structure.md).
![](../img/create_project_net_framework.png)
Если все сделано правильно у вас должен появиться такой код, без строки для вывода в консоль фразы Hello world
